<html>
    ...
    <div class="col-sm-6 col-sm-offset-3">
        <div class="panel panel-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open("admin/Keterlambatan/edit/" .$keterlambatan->kd_keterlambatan); ?>
            <!-- <form class="form-horizontal"> -->
              <div class="panel-body form-horizontal">   
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10" class >
                        <input type="text" class="form-control datepicker"  name="input_tgl_keterlambatan"
                               value="<?php echo set_value('input_tgl_keterlambatan', date("d/m/Y", strtotime($keterlambatan->tgl_keterlambatan))); ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="input_keterangan" value="<?php echo set_value('input_keterangan', $keterlambatan->keterangan); ?>">
                  </div>
                </div>
