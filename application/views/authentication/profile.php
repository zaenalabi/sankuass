	...
	<div class="col-md-3">
		...
		<div class="box box-primary">
			<div class="box-body box-profile">
				...
				<h3 class="profile-id_login text-center"><?php echo $this->session->userdata('first_name')?> <?php echo $this->session->userdata('last_name'); ?></h3>
				...
				<ul class="list-group list-group-unbordered">
					<li class="list-group-item" style="text-align:center">
						<b>id_login</b><br><a><?php echo $this->session->userdata('id_login')?></a>
					</li>
					<li class="list-group-item" style="text-align:center">
				...
				<div class="active tab-pane" id="settings">
					<form class="form-horizontal" action="<?php echo base_url('auth/updateProfile') ?>" method="POST" enctype="multipart/form-data">
						<div class="form-group">
							<label class="col-sm-2 control-label">id_login</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" placeholder="id_login" name="id_login" value="<?php echo $this->session->userdata('id_login'); ?>">
							</div>
						</div>
						<div class="form-group">
